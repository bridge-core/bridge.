...
export default {
	Listeners: {
		get: (id?: string) =>
			id !== undefined ? Runtime.listeners[id] || [] : Runtime.listeners,
		...
		remove: (id: string, listener: (a: any) => any) =>
			(Runtime.listeners[id] = Runtime.listeners[id].filter(
				l => l !== listener
			)),
	},
	Menus: {
		get: (id?: number) =>
			id !== undefined ? Runtime.menus[id] : Runtime.menus,
		add: (id: number, menu: any) => (Runtime.menus[id] = menu),
	},
	Sidebar: {
		get: (id?: number) =>
			id !== undefined ? Runtime.sidebar[id] : Runtime.sidebar,
	...
	Modules: {
		...
		add: (id: string, provide: any) =>
			(Runtime.plugin_modules[id] = provide),
		exists: (id: string) => Runtime.plugin_modules[id] != undefined,
	},
	HL: {
		add: (lang_name: string, lang_def: any) =>
			(Runtime.languages[lang_name] = lang_def),
		exists: (lang_name: string) =>
			Runtime.languages[lang_name] != undefined,
		remove: (lang_name: string): void =>
			(Runtime.languages[lang_name] = undefined),
